...
* Alterada a URL da integração com a Jamef.

= 1.3.4 =

* Correção do cálculo da cubagem.
...
* Correção no método get_fee().

= 1.3.1 =

* Adicionada mensagem informativa em caso de frete com valor 0.
