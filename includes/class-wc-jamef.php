		...
		$this->form_fields = array(
			...
			'unit_origin' => array(
				...
				'options'          => array(
					...
					10             => 'Curitiba (CWB)',
					204            => 'Divinópolis (DIV)',
					192            => 'Feira de Santana (FES)',
					11             => 'Florianópolis (FLN)',
					177            => 'Fortaleza (FOR)',
					148            => 'Goiânia (GYN)',
					4              => 'Jaraguá do Sul (JAS)',
					208            => 'Juíz de Fora (JDF)',
					9              => 'Joinville (JOI)',
					8              => 'Londrina (LDB)',
					149            => 'Manaus (MAO)',
					183            => 'Maceió (MCZ)',
					...
					191            => 'Natal (NAT)',
					14             => 'Porto Alegre (POA)',
					159            => 'Pouso Alegre (PSA)',
					121            => 'Ribeirão Preto (RAO)',
					171            => 'Recife (REC)',
					3              => 'Rio de Janeiro (RIO)',
					2              => 'São Paulo (SAO)',
					125            => 'São José dos Campos (SJK)',
					124            => 'São José do Rio Preto (SJP)',
					168            => 'Salvador (SSA)',
					109            => 'Uberlândia (UDI)',
					209            => 'Vitória da Conquista (VDC)',
					7              => 'Vitória (VIX)'
				)
			),
			'state_origin' => array(
